...
const TRANSLATION_PAIRS: ReadonlyArray<readonly [string, string]> = [
  ...
  ['Sắp xếp danh sách theo dõi', 'Sort watchlist'],
  ...
  ['Ẩn bảng', 'Hide board'],
  ['Hiện bảng', 'Show board'],
  ['Ẩn bảng khỏi trang chủ / thanh điều hướng', 'Hide boards from home / navigation'],
  ['Bảng đã ẩn vẫn mở được bằng link trực tiếp. Theo dõi và email không bị ảnh hưởng.', 'Hidden boards can still be opened via direct link. Watching and email are not affected.'],
  ['Đăng nhập để ẩn bảng.', 'Sign in to hide boards.'],
  ['Đã ẩn bảng khỏi trang chủ.', 'Board hidden from home.'],
  ['Đã hiện lại bảng trên trang chủ.', 'Board shown on home again.'],
  ['Không có bảng hiển thị. Bỏ ẩn trong Cài đặt tài khoản.', 'No boards to show. Unhide them in Account settings.'],
  ...
  ['Ẩn ảnh thu nhỏ', 'Hide thumbnails'],
  ['Danh sách theo dõi chỉ hiện mục chưa đọc', 'Unread-only watchlist'],
  ['Ảnh thu nhỏ:', 'Thumbnails:'],
  ['Chỉ chưa đọc:', 'Unread only:'],
  ['Chủ đề:', 'Threads:'],
  ['Áp dụng trên toàn trang: bài mở đầu, bình luận, ô soạn chủ đề/phản hồi, tin nhắn và biểu mẫu.', 'Applies site-wide to original posts, replies, thread/reply composers, messages, and forms.'],
  ...
  ['Email: bật thông báo', 'Email: enable notifications'],
  ['Email: chủ đề đang theo dõi', 'Email: watched threads'],
  ['Email: bảng đang theo dõi', 'Email: subscribed boards'],
  ['Email: lượt nhắc @tên', 'Email: @username mentions'],
  ['Email: tin nhắn riêng', 'Email: direct messages'],
  ['Chủ đề đang theo dõi', 'Watched threads'],
  ['Trong trang: tin nhắn riêng', 'In-page: direct messages'],
  ['Trình duyệt: chủ đề đang theo dõi', 'Browser: watched threads'],
  ['Trình duyệt: bảng đang theo dõi', 'Browser: subscribed boards'],
  ['Trình duyệt: lượt nhắc @tên', 'Browser: @username mentions'],
  ['Trình duyệt: tin nhắn riêng', 'Browser: direct messages'],
  ['Xác nhận email để bật thông báo email.', 'Verify your email to enable email notifications.'],
  ['Đăng nhập và xác nhận email để bật thông báo email.', 'Sign in and verify your email to enable email notifications.'],
  ['Tắt thông báo trình duyệt cho chủ đề đang theo dõi.', 'Browser notifications for watched threads are off.'],
  ['Trình duyệt này không hỗ trợ thông báo trình duyệt.', 'This browser does not support browser notifications.'],
  ['Trình duyệt đang chặn thông báo của trang này.', 'The browser is blocking notifications from this site.'],
  ['Thông báo trình duyệt đang bật (bảng / chủ đề / lượt nhắc / tin nhắn riêng).', 'Browser notifications are on (boards / watched threads / mentions / direct messages).'],
  ['Đã cấp quyền thông báo trình duyệt; các tùy chọn đang tắt.', 'Browser notification permission is granted; the options are off.'],
  ['Cần cấp quyền thông báo trình duyệt khi lưu cài đặt.', 'Browser notification permission is required when saving settings.'],
  ['Tắt thông báo trình duyệt cho chủ đề / tin nhắn riêng.', 'Browser notifications are off for watched threads and direct messages.'],
  ['Bảng theo dõi', 'Watched boards'],
  ['Bảng:', 'Board:'],
  ['Lưu cài đặt', 'Save settings'],
  ['Cài đặt này không đổi tên hiển thị khi đăng bài và không được đưa vào bài viết công khai.', 'These settings do not change your posting display name and are not included in public posts.'],
  ['Nội dung đã ẩn', 'Hidden content'],
  ['Số chủ đề đã ẩn', 'Hidden thread count'],
  ['Chủ đề đã ẩn', 'Hidden threads'],
  ['Quản lý nội dung đã ẩn', 'Manage hidden content'],
  ['Chưa ẩn chủ đề nào.', 'No hidden threads.'],
  ['[Hiện lại]', '[Restore]'],
  ['Ẩn bài/chủ đề chỉ lưu trên trình duyệt này (không cần tài khoản). Sau khi ẩn, vẫn còn dòng báo đỏ [Hiện lại] trên bảng/chủ đề. Danh sách bên dưới cũng có nút khôi phục.', 'Hidden posts and threads are stored only in this browser (no account required). A red [Restore] row remains on boards and threads, and the list below also provides restore controls.'],
  ['Ẩn bài/chủ đề chỉ lưu trên', 'Hidden posts and threads are stored only in'],
  ['trình duyệt này', 'this browser'],
  ['(không cần tài khoản). Sau khi ẩn, vẫn còn dòng báo đỏ', '(no account required). After hiding, a red restore row remains'],
  ['trên bảng/chủ đề. Danh sách bên dưới cũng có nút khôi phục.', 'on the board/thread. The list below also has restore controls.'],
...
const PATTERN_TRANSLATIONS: PatternTranslation[] = [
  ...
  {
    pattern: /^(\d+) chủ đề đã ẩn$/,
    render: (match) => `${match[1]} hidden threads`
  }
];
