...
export const hiddenBoardsKey = 'hiddenBoards';
...
export const REALTIME_URL = String(process.env.NEXT_PUBLIC_REALTIME_URL || '/events').trim() || '/events';

export const SOCKET_IO_URL = String(process.env.NEXT_PUBLIC_SOCKET_IO_URL || API_BASE_URL).replace(/\/+$/, '');

export const SOCKET_IO_PATH = String(process.env.NEXT_PUBLIC_SOCKET_IO_PATH || '/socket.io').trim() || '/socket.io';
